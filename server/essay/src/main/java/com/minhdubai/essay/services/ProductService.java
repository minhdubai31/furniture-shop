...
public interface ProductService {
    ProductDto create(ProductDto product, Integer categoryId, Integer brandId);
    ...
    ProductDto update(Integer id, ProductDto updateFields, Integer newCategoryId, Integer newBrandId);
