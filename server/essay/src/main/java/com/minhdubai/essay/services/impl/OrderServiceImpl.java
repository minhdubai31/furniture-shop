...
import com.minhdubai.essay.repositories.CartAndOrderItemDetailRepository;
import com.minhdubai.essay.repositories.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public OrderDto transferCartToOrder(Integer userId) {
    ...
    @Override
    public OrderDto buyNowOrder(Integer userId, Integer productId) {
        UserEntity orderedUser = userRepository.findById(userId)
                .orElseThrow(() -> new EntityNotFoundException("User with id = " + userId + "not found"));
